(function () {
	...
	function loadNearbyItems() {
		loadItems('https://35.173.220.122:8443/EventRecommender/search', `user_id=${user_id}&lat=${lat}&lon=${lng}`, 'Nearby items not found.');
	}

	function loadFavoriteItems() {
		loadItems('https://35.173.220.122:8443/EventRecommender/history', `user_id=${user_id}`, 'No favorite items found.', true);
	}

	function loadRecommendedItems() {
		loadItems('https://35.173.220.122:8443/EventRecommender/recommendation', `user_id=${user_id}&lat=${lat}&lon=${lng}`, 'No recommended items found.');
	}
