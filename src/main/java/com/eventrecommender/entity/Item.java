package com.eventrecommender.entity;
...
/**
 * Represents an event or item entity with detailed attributes such as name, 
 * address, categories, location, and more. This class uses the Builder 
 * pattern for constructing immutable objects.
 */
public class Item {
    ...
    private String city;            // City where the event is held
    private String country;         // Country where the event is held
    private String state;           // State where the event is held
    private String zipcode;         // Zipcode of the event location
    private String date;            // Event date
    private String priceRange;      // Price range for the event tickets
    private double latitude;        // Latitude of the event location
    private double longitude;       // Longitude of the event location
    private String description;     // Description of the event
    private Set<String> categories; // Categories associated with the event
    private String imageUrl;        // URL of the event image
    private String url;             // URL to the event's webpage
    private String snippet;         // Short snippet about the event
    private String snippetUrl;      // URL to a snippet about the event

    /**
     * Private constructor to enforce object creation using the builder pattern.
     */
    ...
    /**
     * Overriding hashCode for proper comparison in collections.
     */
    @Override
    public int hashCode() {
        final int prime = 31;
    ...
    /**
     * Overriding equals to ensure equality based on `itemId`.
     */
    @Override
    ...
    /**
     * Converts the Item object to a JSONObject representation.
     * 
     * @return A JSONObject containing all attributes of the Item.
     */
    ...
    // Getter methods for accessing the properties of the Item.
